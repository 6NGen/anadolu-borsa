...
const etiket: React.CSSProperties = { fontSize: "12px", color: RENKLER.muted, letterSpacing: "0.12em", marginBottom: "12px", fontWeight: 600 };
  ...
  return (
    <main style={{ maxWidth: "1000px", margin: "0 auto", padding: "16px", fontFamily: "var(--font-mono)" }}>
      <div style={{ marginBottom: "16px" }}>
        ...
        <p style={{ fontSize: "13px", color: RENKLER.muted, marginTop: "5px", lineHeight: 1.5 }}>Bölge havası, fiyat trendi ve ortalama hasat takvimi tek ekranda. Yorum yok — yalnızca veri.</p>
      </div>
        ...
        <div style={kart}>
          ...
          {takvim ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <div style={{ fontSize: "12px", color: RENKLER.muted, lineHeight: 1.5 }}>Ortalamadır; bölge, rakım ve yıla göre değişir. Kaynak: il tarım müdürlükleri / TÜİK yayınları.</div>
            </div>
          ) : (
      ...
      <div style={{ ...kart, marginTop: "12px" }}>
        ...
        {guncel && (
          <div style={{ fontSize: "12px", color: RENKLER.muted, marginTop: "8px" }}>Güncel: {formatFiyat(guncel.fiyat)} TL/kg · {guncel.kaynak} · {kisaTarih(guncel.tarih)}</div>
        )}
      </div>
    </main>
  );
