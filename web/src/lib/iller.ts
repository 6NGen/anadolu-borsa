// Türkiye'nin 81 ili — fiyat bildirimi <select> için sabit liste.
// Serbest metin "KONYA"/"Konya"/"konya" üç ayrı kayıt üretip
// piyasa_fiyatlari GROUP BY il'i bozuyordu.
export const ILLER = [
